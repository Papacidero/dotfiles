...
plugins=(git autojump common-aliases npm git-extras)

source $ZSH/oh-my-zsh.sh

# User configuration

#export PATH="/usr/local/apache-maven-3.2.3/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/local/git/bin:/usr/local/mysql-5.6.20-osx10.8-x86_64/bin"
